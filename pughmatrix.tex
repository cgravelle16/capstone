...
\begin{table}[htbp]
\centering
\caption{Pugh Matrix to select Placement of the Four Motor. The options for the motor placement are inside the chassis or outside.}
...
\rowstyle{\bfseries}  & \# positives &  & 0 & 13 & 6 \\
 ...
 \begin{table}[htbp]
\centering
\caption{Pugh Matrix to select drive mechanism. The options are belts, chains, and direct drive.}
...
\rowstyle{\bfseries}  & \# negatives &  & 0 & 1 & 1 & 4\\ \hline
 ...
 \begin{table}[htbp]
\centering
\caption{Pugh Matrix to select between coupled versus independent wheel suspension}
...
\rowstyle{\bfseries}  & Subtotal &  & 0 & 8 & 0 \\ \hline \hline
...
\rowstyle{\bfseries}  & \# negatives &  & 0 & 3 & 0 \\ \hline
 ...
 \begin{table}
\centering
\caption{Pugh Matrix to select suspension type for coupled wheels.}
